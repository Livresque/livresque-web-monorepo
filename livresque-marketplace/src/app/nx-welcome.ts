      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build livresque-marketplace
<span># Test</span>
nx test livresque-marketplace
<span># Lint</span>
nx lint livresque-marketplace
<span># Run them together!</span>
nx run-many -p livresque-marketplace -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project livresque-marketplace</pre>
          </details>
