      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build livresque-management
<span># Test</span>
nx test livresque-management
<span># Lint</span>
nx lint livresque-management
<span># Run them together!</span>
nx run-many -p livresque-management -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project livresque-management</pre>
          </details>
